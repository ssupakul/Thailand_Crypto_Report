...
# แก้ไข: เปลี่ยนเป็นตัวพิมพ์เล็ก และใส่ '_' คั่นระหว่างเหรียญกับ THB ตามระบบ Binance TH API
WATCHLIST = ["btc_thb", "eth_thb", "bnb_thb", "sol_thb", "xrp_thb", "ada_thb", "doge_thb", "eigen_thb", "floki_thb"]
...
def get_historical_data(symbol, interval="4h", limit=100):
    ...
    # ตรวจสอบให้แน่ใจว่าค่าที่ส่งไปเป็นตัวพิมพ์เล็กทั้งหมด
...
def screen_crypto():
    ...
    for symbol in WATCHLIST:
        # แปลงชื่อแสดงผลให้ดูง่ายขึ้นตอนพิมพ์ log (เช่น btc_thb -> BTC_THB)
        display_symbol = symbol.upper()
        print(f"Scanning {display_symbol} on Binance TH...")
